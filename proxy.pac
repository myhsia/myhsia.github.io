...
function FindProxyForURL(url, host) {
    ...
    var isTargetStandard = (
        ...
        isDomain(host, "google.com.hk")                      ||
        isDomain(host, "google.com.sg")                      ||
        ...
        // AI
        //// OpenAI
        isDomain(host, "chatgpt.com")                        ||
        //// Anthropic
        isDomain(host, "anthropic.com")                      ||
        isDomain(host, "claude.ai")                          ||
        //// Hugging Face
